...
| `MS-Agent工程文件\20_执行/node_modules` | ❌ 绝不传 | 体积大，别人 `npm install` 自己装 |
...
2. 确认能看到：`README.md`、`MS-Agent工程文件` 文件夹、`启动面试助手Agent.bat` 等
3. 点进 `MS-Agent工程文件\20_执行`，确认能看到 `config.example.json`、**看不到** `config.json` 和 `node_modules`
